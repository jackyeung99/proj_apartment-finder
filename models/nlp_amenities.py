...
class nlp_processor:
    def __init__(self, word2vec_model):
        ...
        self.categories = {
            ...
            'Services': ['laundry facilities', 'dishwasher', 'maintenance', 'package service', 'valet trash removal'],
            ...
            'Apartment_features': ['granite countertops','12ft ceilings','stainless_steel appliances','Walk-in closet']
        }
    ...
    def categorize_items(self, input_list):
        ...
        for item in phrased_list:
            ...
            if item_embedding is not None:
                ...
                if best_category is not None and min_distance < .7: 
...
if __name__ == "__main__":
    ...
    nlp = nlp_processor(word2vec_model)
    nlp.main(test_list)
